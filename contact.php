...
?>
    ...
    <div class="modal" id="creatmodal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form id="form" method="POST" onsubmit="validateContact(event);">
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-md-6 form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control mt-2" placeholder="Enter name">
                                <div class="error">
                                    <?php
                                    if (isset($_GET['error'])) {
                                        echo $_GET['error'];
                            ...
                            <div class="col-xs-6 col-md-6 form-group">
                                ...
                                <input type="number" name="phone" id="phone" class="form-control mt-2" placeholder=" Enter phone">
                                <div class="error">
                                    <?php
                                    if (isset($_GET['error'])) {
                                        echo $_GET['error'];
                        ...
                        <div class="form-group ">
                            ...
                            <textarea type="text" id="adresse" name="adresse" class="form-control md-textarea mt-2" placeholder="Enter adresse"></textarea>
                            <div class="error">
                                <?php
                                if (isset($_GET['error'])) {
                                    echo $_GET['error'];
